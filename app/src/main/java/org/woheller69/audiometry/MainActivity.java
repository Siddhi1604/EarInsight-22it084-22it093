...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkShowInvisibleButtons(){
        ...
        if (FileOperations.isCalibrated(this)) {
            ...
            if (GithubStar.shouldShowStarDialog(this)) GithubStar.starDialog(this,"https://github.com/Siddhi1604/APP-Based-Digital-Audiometer-22IT084-22IT093");
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.backup) {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Siddhi1604/APP-Based-Digital-Audiometer-22IT084-22IT093 ")));
            return true;
        }
